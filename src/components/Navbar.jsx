  ...
  return (
    <nav className="w-64 h-full bg-blue-700 p-6 flex flex-col">
      ...
      <ul className="space-y-4 flex-grow">
        <li>
          <Link to="/upload" className="block w-full text-white text-lg bg-blue-600 hover:bg-blue-500 rounded-lg py-3 px-4 transition duration-150 ease-in-out font-bold">
            Upload
          </Link>
        </li>
        <li>
      ...
      <div className="mt-auto">
        <Link to="/" className="block w-full text-blue-700 text-lg bg-white hover:bg-blue-100 rounded-lg py-3 px-4 transition duration-150 ease-in-out font-bold">
          Logout
        </Link>
      </div>
    </nav>
